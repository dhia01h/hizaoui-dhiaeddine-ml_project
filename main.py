...
from mlflow_utils import get_elasticsearch_client, log_to_elasticsearch  # 🔥 Importer Elasticsearch
...
def main():
    ...
    parser.add_argument("--data", type=str, default="churn-bigml-80.csv", help="Chemin du fichier CSV")
    parser.add_argument("--train", action="store_true", help="Entraîner le modèle")
    parser.add_argument("--evaluate", action="store_true", help="Évaluer le modèle")
    parser.add_argument("--save", type=str, default="random_forest.pkl", help="Nom du fichier pour sauvegarder le modèle")
        ...
        if args.evaluate:
            if model is None:
                ...
                for metric, value in metrics.items():
                    ...
                    print(f"📤 Envoi de la métrique {metric}: {value} à Elasticsearch...")  # 🔍 Debug
                    try:
